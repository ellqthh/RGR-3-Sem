...
app.layout = html.Div([
    ...
    dcc.RadioItems(options=[
        {'label': '1', 'value': '1'},
        {'label': '1', 'value': '2'}
    ], value='Обслуживание', id='controls-and-radio-item'),
...
def update_data_and_graph(contents, filename, col_chosen):
    if contents is not None:
        ...
        fig_hist = px.histogram(df, x='1', y=col_chosen, histfunc='avg')
        fig_pie = px.pie(df, values='1',  names='2')
        fig_bar = px.bar(df, x='1', y='2')
